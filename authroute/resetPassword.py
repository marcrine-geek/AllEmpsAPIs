...
from .errors import InternalServerError, EmailDoesnotExistsError, PasswordLengthError, BadTokenError, ExpiredTokenError
...
class ForgotPasswordResource(Resource):
	...
	def post(self):
		...
		try:
			...
			user = UserModel.query.filter_by(email=body.get('email')).first()
			if not user:
